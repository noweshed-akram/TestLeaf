package com.awsprep.user.data.local.di

import android.content.Context
import com.awsprep.user.data.local.dao.EntityDao
import com.awsprep.user.data.local.db.TestPrepDb
...
object DatabaseModule {
    ...
    @Singleton
    @Provides
    fun providesEntityDao(muslimAppDd: TestPrepDb): EntityDao {
        return muslimAppDd.entityDao()
    }
